...
public class Assets {
    ...
    public static void init(){
        ...
        try{
            ...
            btn_start[0] = startbtn.crop(0, height*2, width*2, height);
            btn_start[1] = startbtn.crop(0, height*3, width*2, height);

            //replay button
            btn_replay = new BufferedImage[2];
            btn_replay[0] = replaybtn.crop( 0, height*2, width*2, height);
            btn_replay[1] = replaybtn.crop(0, height*3, width*2, height);
            ...
            System.out.println("Error loading file resources. Please double-check your file names before" +
                    "re-running the game!");
            System.exit(0);
        }
